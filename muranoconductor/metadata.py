...
import tempfile
import hashlib
from metadataclient.common.exceptions import CommunicationError, HTTPException
...
def get_metadata(token_id):
    ...
    try:
        ...
        if hash:
            ...
            e.message += 'Unable to get data from Metadata Repository'
            raise
    else:
        if resp.status == 304:
...
def release(folder):
    ...
    try:
        ...
        log.error('Unable to delete folder {0} with '
