...
class TestWindowsAgent(unittest.TestCase):
    def setUp(self):
        ...
        self.mfs.add_entries({
            './data/templates/cf/test.template':
                json.dumps(self.template),
            './data/templates/cf/scripts/Get-DnsListeningIpAddress.ps1':
                'function GetDNSip(){\ntest\n}\n',
            './data/templates/cf/scripts/Join-Domain.ps1':
                'function JoinDomain(){\ntest\n}\n',
        })
    ...
    def test_script_encode(self):
        ...
        encoded = [
            'ZnVuY3Rpb24gR2V0RE5TaXAoKXsKdGVzdAp9CmZ1bmN0aW9uIEpvaW5Eb21ha\
W4oKXsKdGVzdAp9\nCg==\n'
        ]
