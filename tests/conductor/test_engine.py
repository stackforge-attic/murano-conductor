...
from muranoconductor.engine import yaql_expression
...
class TestObjectsManipulation(unittest.TestCase):
    ...
    def test_object_id(self):
        _id = 'some_id'
        patch_at = 'muranoconductor.engine.objects.helpers.generate_id'
    ...
    def test_set_property(self):
        ...
        with mock.patch('yaql.context.Context') as ctx_mock:
            with mock.patch('muranoconductor.engine.helpers') as helpers_mock:
